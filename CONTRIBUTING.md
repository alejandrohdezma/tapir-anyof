...
If you have any question or problem with _tapir-anyof_ feel free to open an [issue](https://github.com/alejandrohdezma/tapir-anyof/issues) (or a [pull request](https://github.com/alejandrohdezma/tapir-anyof/pulls) if you already have the solution :smile:).

People are expected to follow the [Code of Conduct](CODE_OF_CONDUCT.md) when discussing on the Github issues or PRs.

## How can I help?

_tapir-anyof_ follows a standard [fork and pull](https://help.github.com/articles/using-pull-requests/) model for contributions via GitHub pull requests.
